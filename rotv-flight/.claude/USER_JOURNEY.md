...
## 2. Preflight Check
    ...
    side-by-side: one box is a a systems 3d model showed in a scene, the other box is a list of preflight checks
    - Arbitrary list of preflight checks, can be pending, checking, success, and failed. Imagine software tests! ("Battery - Error", "I/O Module - Success","Flap - starboard: pending", "Motionsensor: Pending")
